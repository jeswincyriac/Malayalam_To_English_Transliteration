...
filem = codecs.open("secondroundmalayalamwords.txt","r",encoding="utf-8")
#fileeng = open ("english.txt","r")
out = codecs.open ("test.txt","w",encoding="utf-8")
...
while malword != "" :
    ...
    while malword[i] !="$":
        ...
        if ( (exp or exp2 or malword[i+1] =="ൊ") and (malword[i+2] =="ം" or malword[i+2] ==" ")):
